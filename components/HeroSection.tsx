      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <Link
              href="/about"
              className="bg-background text-primary border-2 border-primary/20 px-8 py-4 rounded-xl font-semibold hover:bg-primary/5 hover:border-primary/40 transition-all hover:scale-105 active:scale-95 shadow-md hover:shadow-lg dark:bg-card dark:border-white/20 dark:hover:bg-white/10 dark:text-black dark:font-semibold"
            >
              Our Story
            </Link>
          </motion.div>
